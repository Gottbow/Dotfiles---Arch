...
launch_bars() {
	...
	for mon in $(polybar --list-monitors | cut -d":" -f1); do
		MONITOR=$mon polybar -q jan -c ${rice_dir}/config.ini &
		MONITOR=$mon polybar -q jan2 -c ${rice_dir}/config.ini &
		MONITOR=$mon polybar -q jan3 -c ${rice_dir}/config.ini &
		MONITOR=$mon polybar -q jan4 -c ${rice_dir}/config.ini &
	done
